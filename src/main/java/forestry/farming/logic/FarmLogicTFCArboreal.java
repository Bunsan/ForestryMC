...
public class FarmLogicTFCArboreal
        extends FarmLogicHomogeneous {
    private static final int BRANCH_RANGE = 20;

    public FarmLogicTFCArboreal(IFarmHousing housing, ItemStack resource, ItemStack ground, Iterable<IFarmable> germlings) {
        super(housing, resource, ground, germlings);
    }

    public FarmLogicTFCArboreal(IFarmHousing housing) {
